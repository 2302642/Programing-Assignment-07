...
namespace { // anonymous namespace
  ...
  template <typename T1, typename T2> std::ostream& operator<<(std::ostream& os, std::pair<T1, T2>const& rhs);
  // write to output stream a hlp2::vector<T>
  template <typename T> std::ostream& operator<<(std::ostream& os, hlp2::vector<T> const& rhs);
  // write to output stream a hlp2::vector<T>
  template <typename T> void Print(hlp2::vector<T> const& lhs, std::string const& newline = "\n", std::ostream& os=std::cout);
